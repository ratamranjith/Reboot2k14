...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "members_edge.js"},
      { load: "members_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="100%",plHeight="400px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['400', '275','85px','85px','auto', 'auto'],
